package cn.edu.sut.informationSecruity23.operation.verifier;
...
public class VerifierOperation {
    ...
    public static Boolean Verify(Proof proof, Element[][] ivk, String message) {
        ...
        System.out.println();
        System.out.println("verify: "+cc);
        System.out.println(D_1.isEqual(proof.getD1()));
        System.out.println(D_2.isEqual(proof.getD2()));
        System.out.println(D_3.isEqual(proof.getD3()));
        System.out.println(D_4.isEqual(proof.getD4()));
        return cc.isEqual(c);
    }
}
