package cn.edu.sut.informationSecruity23.param;

import cn.edu.sut.informationSecruity23.SecurityBaseTest;
...
public class Issuer2Param {
    private static final int attrSize=2;
    private static final int size=attrSize+2;
    private static final String fileName="issuer2.properties";

    public static Element[] isk;
    public static Element[] ivk;
    public static String[] attribute={"发行方2属性1","发行方2属性2"};
