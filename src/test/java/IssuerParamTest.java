import cn.edu.sut.informationSecruity23.param.Issuer1Param;
import cn.edu.sut.informationSecruity23.param.Issuer2Param;
...
public class IssuerParamTest {
    ...
    public void readParam2(){
        Element[] isk = Issuer2Param.isk;
        Element[] ivk = Issuer2Param.ivk;
        System.out.println(PublicParam.g2.duplicate().powZn(isk[0]).isEqual(ivk[0]));
    }
